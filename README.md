...
### 🔌 Browser Extensions
> **[View Diagram](./path/to/extensions-diagram.png)**
> *Explains the lifecycle of background scripts, content scripts, and popup interactions.*

### 🔐 Authentication Flows
> **[View Diagram](./path/to/auth-flow.png)**
> *Visualizing JWT, Session-based auth, and OAuth2 handshakes.*
